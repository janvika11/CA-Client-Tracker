  ...
  return (
    <input
      ...
      className={cn(
        ...
        'shadow-sm dark:border-dm-border dark:bg-dm-surface dark:text-dm-fg dark:shadow-none dark:placeholder:text-dm-muted dark:hover:border-dm-border dark:focus:border-emerald-500',
